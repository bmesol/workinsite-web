...
import { WorkModeCreationPage } from "@/shared/features/workers/pages/worker-mode-creation/WorkerModeCreation"; // ✅ added
import { ShiftCreationPage } from "@/shared/features/workers/pages/shift-create/ShiftCreationPage"           // ✅ added
...
const UrlPages = {
  ...
  "/work-modes":                       { page: WorkModeCreationPage,               allowedUserRoles: ALL_USERS }, // ✅ added
