...
//             <div style={{ borderRadius: '1rem', padding: '1rem', background: '#dcfce7', border: '1px solid #86efac' }}>
//               <div className="flex items-center gap-2 mb-1">
//                 <CheckCircle2 className="w-4 h-4" style={{ color: '#16a34a' }} />
//                 <span style={{ fontSize: 'var(--font-sm)', fontWeight: 700, color: '#15803d' }}>Currently Checked In</span>
//               </div>
//               <p style={{ fontSize: 'var(--font-sm)', color: '#374151' }}>
...
//                   <p style={{ fontSize: 'var(--font-xs)', color: '#6b7280', lineHeight: 1.4 }}>
//                     {checkIn.currentLocation.address}
//                   </p>
//                 </div>
//               )}
...
//                   <p style={{ fontSize: 'var(--font-md)', fontWeight: 700, color: 'var(--foreground)' }}>Check In to Site</p>
//                   <p style={{ fontSize: 'var(--font-xs)', color: '#6b7280', marginTop: 2 }}>Tap to record location &amp; start shift</p>
//                 </div>
//               </>
//             )}
//           </button>
...
//                   <div className="w-3 h-3 rounded-full flex-shrink-0" style={{ background: mySite.status === 'Working' ? '#22c55e' : '#f59e0b' }} />
                ...
                return (
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <p style={{ fontSize: 'var(--font-xs)', color: '#374151' }}>{ci.date}</p>
